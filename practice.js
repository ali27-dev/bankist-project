...
//3
const { deposite, withdrewal } = accounts
  .flatMap(mov => mov.movements)
  .reduce(
    (sums, curr) => {
      sums[curr > 0 ? 'deposite' : 'withdrewal'] += curr;
      return sums;
    },
    { deposite: 0, withdrewal: 0 }
  );
console.log(deposite, withdrewal);
...
// 4.
// console.log(
//   `"${ownersEatTooMuch} dogs eat too much! and ${ownersEatTooLittle} dogs eat too little!"`
// );
console.log(`${ownersEatTooMuch.join(' and ')}'s dogs eat too much!`);
console.log(`${ownersEatTooLittle.join(' and ')}'s dogs eat too little!`);

// const str1 = `"${ownersEatTooMuch} dogs eat too much!"`;
// const str2 = `"${ownersEatTooLittle} dogs eat too little!"`;
// console.log(str1, 'and', str2);

// 5.
const result = dogs.some(
  element => element.curFood === element.recommendedFood
);
console.log(result);
// 6.
// current > (recommended * 0.90) && current < (recommended * 1.10)
const oakyAmountFood = dog =>
  dog.curFood > dog.recommendedFood * 0.9 &&
  dog.curFood < dog.recommendedFood * 1.1;
console.log(dogs.some(oakyAmountFood));
// 7.
const newArr = dogs.filter(oakyAmountFood);
console.log(newArr);
...
console.log(345_6543);

const PI = 3.14_65;
console.log(PI);

console.log(Number('234_123'));
console.log(parseInt('234_123'));
...
console.log(34243453454645756768678765465323424n);
console.log(123432443546464545343n * 32342342n);

// operation
console.log(10000n * 134234235345n);

const huge = 23434524232423n;
const num = 23;
